...
public interface LatestPartyStudentProgressRepository extends JpaRepository<LatestPartyStudentProgress, Long> {
    ...
    Optional<LatestPartyStudentProgress> findByStudentUserIdAndFlowIdAndIsDeleted(Long studentUserId, Long flowId, Integer isDeleted);

    List<LatestPartyStudentProgress> findAllByStudentUserIdAndIsDeleted(Long studentUserId, Integer isDeleted);
}
